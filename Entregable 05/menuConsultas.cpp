    ...
    if (!existeImporte) {
        ...
        while (indice < 0 or indice >= consultas.length()) {
            ...
            if (indice < 0 or indice >= consultas.length()) {
                ...
                gotoxy(3, 12);
                std::cout <<AQB<< "Codigo de Consulta: " << GB << consultas.indice(indice).getCodigo() <<RTNC<<std::endl;
                gotoxy(3, 13);
...
void MenuConsultas::imprimirTodo() {
    if (!existeImporte) {
        ...
        for (int i = 0; i < consultas.length(); i++) {
            ...
            std::cout <<AQB<< "Codigo de Consulta: " << GB << consultas.indice(i).getCodigo() <<RTNC<<std::endl;
